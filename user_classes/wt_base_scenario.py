...
class PurchaseFlightTicket(SequentialTaskSet): # класс с задачами (содержит основной сценарий)
    ...
    def on_start(self) -> None:
        ...
        @task
        def uc01_01_getLogin(self) -> None:
    ...
    def uc01_04_findFlight(self):
        ...
        req_body_04_01 = f'advanceDiscount=0&depart={self.depart}&departDate={date_list["depart_date"]}&arrive={self.arrive}&returnDate={date_list["arrive_date"]}&numPassengers=1&seatPref={self.seatPref}&seatType={self.seatType}&findFlights.x=51&findFlights.y=6&.cgifields=roundtrip&.cgifields=seatType&.cgifields=seatPref'
    ...
    def uc01_05_choiceFlight(self):
        req_body_05_01 = f'outboundFlight={unquote_plus(self.outboundFlight)}&numPassengers=1&advanceDiscount=0&seatType={self.seatType}&seatPref={self.seatPref}&reserveFlights.x=60&reserveFlights.y=10'
    ...
    def uc01_06_paymentFlight(self):
        ...
        req_body_06_01 = f'firstName={self.userName}&lastName={self.password}&address1={self.address1}1&address2={self.address2}&pass1={self.pass1}&creditCard={self.creditCard}&expDate={self.expDate}&saveCC=on&oldCCOption=on&numPassengers=1&seatType={self.seatType}&seatPref={self.seatPref}&outboundFlight={self.outboundFlight}&advanceDiscount=0&returnFlight=&JSFormSubmit=off&buyFlights.x=27&buyFlights.y=4&.cgifields=saveCC'
